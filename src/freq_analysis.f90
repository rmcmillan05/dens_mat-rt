...
SUBROUTINE get_freq_amp(field_in,                                              &
    ...
    USE params ,        ONLY : start_from, go_to, use_max_freq
    IMPLICIT NONE
    ...
    CHARACTER(LEN=20)                          :: max_err_char
    CHARACTER(LEN=20)                          :: gt_char_o
    CHARACTER(LEN=20)                          :: gt_char_n
    REAL(KIND=DP)                              :: dt_in
...
SUBROUTINE add_freqs(freqs_in, freqs_out)
    USE double
    USE params , ONLY : c_diffs, max_order
    IMPLICIT NONE
